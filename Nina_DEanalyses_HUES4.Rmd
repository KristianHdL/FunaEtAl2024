...
dds<-dds[,colData(dds)$Cell_line=="HUES4"]

dds <- DESeqDataSetFromMatrix(countData = counts(dds),colData=colData(dds), design= ~Exp_batch+Treatment) 
...
dds<-DESeq(dds)
(treatmentList<-resultsNames(dds)[-c(1:3)])
